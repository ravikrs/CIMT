package de.rwth.i9.cimt.algorithm.kpextraction.jate;
...
public class Jate {
	...
	public static List<JATETerm> TTFAlgo(String text) throws JATEException, IOException, SolrServerException {
	...
	public static List<JATETerm> ATTFAlgo(String text) throws JATEException, IOException, SolrServerException {
		String workingDir = System.getProperty("user.dir");
		Path solrHome = Paths.get(workingDir, "testdata", "solr-testbed");
		String solrHomeDir = solrHome.toString();
		List<JATETerm> terms = new ArrayList<>();
	...
	public static List<JATETerm> TFIDFAlgo(String text) throws JATEException, IOException, SolrServerException {
		String workingDir = System.getProperty("user.dir");
		Path solrHome = Paths.get(workingDir, "testdata", "solr-testbed");
		String solrHomeDir = solrHome.toString();
		List<JATETerm> terms = new ArrayList<>();
	...
	public static List<JATETerm> RIDFAlgo(String text) throws JATEException, IOException, SolrServerException {
		String workingDir = System.getProperty("user.dir");
		Path solrHome = Paths.get(workingDir, "testdata", "solr-testbed");
		String solrHomeDir = solrHome.toString();
		List<JATETerm> terms = new ArrayList<>();
	...
	public static List<JATETerm> CValueAlgo(String text) throws JATEException, IOException, SolrServerException {
		String workingDir = System.getProperty("user.dir");
		Path solrHome = Paths.get(workingDir, "testdata", "solr-testbed");
		String solrHomeDir = solrHome.toString();
		List<JATETerm> terms = new ArrayList<>();
	...
	public static List<JATETerm> ChiSquareAlgo(String text) throws JATEException, IOException, SolrServerException {
		String workingDir = System.getProperty("user.dir");
		Path solrHome = Paths.get(workingDir, "testdata", "solr-testbed");
		String solrHomeDir = solrHome.toString();
		List<JATETerm> terms = new ArrayList<>();
	...
	public static List<JATETerm> WeirdnessAlgo(String text) throws JATEException, IOException, SolrServerException {
		String workingDir = System.getProperty("user.dir");
		Path solrHome = Paths.get(workingDir, "testdata", "solr-testbed");
		String solrHomeDir = solrHome.toString();
		List<JATETerm> terms = new ArrayList<>();
	...
	public static List<JATETerm> GlossExAlgo(String text) throws JATEException, IOException, SolrServerException {
		String workingDir = System.getProperty("user.dir");
		Path solrHome = Paths.get(workingDir, "testdata", "solr-testbed");
		String solrHomeDir = solrHome.toString();
		List<JATETerm> terms = new ArrayList<>();
	...
	public static List<JATETerm> TermExAlgo(String text) throws JATEException, IOException, SolrServerException {
		String workingDir = System.getProperty("user.dir");
		Path solrHome = Paths.get(workingDir, "testdata", "solr-testbed");
		String solrHomeDir = solrHome.toString();
		List<JATETerm> terms = new ArrayList<>();
	...
	private static void freeSolrLocks() {
		String workingDir = System.getProperty("user.dir");
		Path solrHome = Paths.get(workingDir, "testdata", "solr-testbed");
		String solrCoreName = "ACLRDTEC";
